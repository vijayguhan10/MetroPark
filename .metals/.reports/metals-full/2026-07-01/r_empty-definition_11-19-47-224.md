error id: file:///C:/Users/vguhankm/projects/MetroPark/Metropark/src/main/java/com/example/Metropark/repo/ParkingSlotRepository.java:_empty_/DSLContext#update#
file:///C:/Users/vguhankm/projects/MetroPark/Metropark/src/main/java/com/example/Metropark/repo/ParkingSlotRepository.java
empty definition using pc, found symbol in pc: _empty_/DSLContext#update#
...
public class ParkingSlotRepository {
    ...
    public Mono<Integer> updateStatus(Integer id, String status) {
        return Mono.from(dsl.upd@@ate(table("parking_slots"))
