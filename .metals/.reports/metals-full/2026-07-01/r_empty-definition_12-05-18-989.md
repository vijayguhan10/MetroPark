error id: file:///C:/Users/vguhankm/projects/MetroPark/Metropark/src/main/java/com/example/Metropark/service/ReservationService.java:_empty_/ReservationRepository#updateStatusWithOptimisticLock#
file:///C:/Users/vguhankm/projects/MetroPark/Metropark/src/main/java/com/example/Metropark/service/ReservationService.java
empty definition using pc, found symbol in pc: _empty_/ReservationRepository#updateStatusWithOptimisticLock#
...
public class ReservationService {
        ...
        return parkingSlotRepository.findById(dto.slotId())
                ...
                .flatMap(slot -> {
                    ...
                    return parkingSlotRepository
                            .updateStatusWithOptimisticLock(slot.slotId(), "RESERVED", slot.slotVersion())
                            .flatMap(rowsUpdated -> {
                                if (rowsUpdated == 0) {
                                    return Mono.error(new IllegalStateException("Slot not available."));
                                }
    ...
    public Mono<Integer> updateStatus(Integer id, String status, Integer currentVersion) {
        ...
        return reservationRepository.up@@dateStatusWithOptimisticLock(id, status.trim().toUpperCase(), currentVersion)
                .flatMap(rowsUpdated -> {
                    if (rowsUpdated == 0) {
