error id: file:///C:/Users/vguhankm/projects/MetroPark/Metropark/src/main/java/com/example/Metropark/service/res.java:_empty_/ReservationRepository#
file:///C:/Users/vguhankm/projects/MetroPark/Metropark/src/main/java/com/example/Metropark/service/res.java
empty definition using pc, found symbol in pc: _empty_/ReservationRepository#
empty definition using semanticdb
empty definition using fallback
non-local guesses:

offset: 419
uri: file:///C:/Users/vguhankm/projects/MetroPark/Metropark/src/main/java/com/example/Metropark/service/res.java
text:
```scala
...
public class ReservationService {
    ...
    private final R@@eservationRepository reservationRepository;
    private final ParkingSlotRepository parkingSlotRepository;

    public ReservationService(ReservationRepository reservationRepository, ParkingSlotRepository parkingSlotRepository) {
    ...
    public Mono<Integer> createReservation(ReservationDto dto) {
        ...
        return parkingSlotRepository.findById(dto.slotId())
                ...
                .flatMap(slot -> {
                    ...
                    return parkingSlotRepository.updateStatusWithOptimisticLock(slot.slotId(), "RESERVED", slot.slotVersion())
                            .flatMap(rowsUpdated -> {
                                if (rowsUpdated == 0) {
                                    return Mono.error(new IllegalStateException("Slot not available."));
                                }
