error id: file:///C:/Users/vguhankm/projects/MetroPark/Metropark/src/main/java/com/example/Metropark/service/ReservationService.java
file:///C:/Users/vguhankm/projects/MetroPark/Metropark/src/main/java/com/example/Metropark/service/ReservationService.java
### com.thoughtworks.qdox.parser.ParseException: syntax error @[24,23]
    ...
    public ReservationService(ReservationRepository reservationRepository,
        ...
        return parkingSlotRepository.findById(dto.slotId())
                ...
                .flatMap(slot -> {
                    ...
                    return parkingSlotRepository.updateStatus(slot.slotId(), "RESERVED")
                            .flatMap(rowsUpdated -> {
                                if (rowsUpdated == 0) {
                                    return Mono.error(new IllegalStateException("Slot not available."));
                                }
...
QDox parse error in file:///C:/Users/vguhankm/projects/MetroPark/Metropark/src/main/java/com/example/Metropark/service/ReservationService.java