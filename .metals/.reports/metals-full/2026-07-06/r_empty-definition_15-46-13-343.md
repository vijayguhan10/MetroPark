error id: file:///C:/Users/vguhankm/projects/MetroPark/Metropark/src/main/java/com/example/Metropark/service/ParkingSessionService.java:_empty_/`<any>`#onErrorResume#
...
empty definition using pc, found symbol in pc: _empty_/`<any>`#onErrorResume#
...
public class ParkingSessionService {
    ...
    public Mono<Integer> createSession(ParkingSessionDto dto) {
        ...
        return Mono.when(
                ...
                }))  .onE@@rrorResume(error -> Mono.just("Error: " + error.getMessage()));
    }
