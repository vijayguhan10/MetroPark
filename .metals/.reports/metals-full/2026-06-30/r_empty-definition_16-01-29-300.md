error id: file:///C:/Users/vguhankm/projects/MetroPark/Metropark/src/main/java/com/example/Metropark/service/ReservationService.java:java/lang/String#equalsIgnoreCase().
file:///C:/Users/vguhankm/projects/MetroPark/Metropark/src/main/java/com/example/Metropark/service/ReservationService.java
empty definition using pc, found symbol in pc: java/lang/String#equalsIgnoreCase().
...
public class ReservationService {
    ...
    public Mono<Integer> createReservation(ReservationDto dto) {
        ...
        return parkingSlotRepository.findById(dto.slotId())
                ...
                .flatMap(slot -> {
                    if (!"AVAILABLE".eq@@ualsIgnoreCase(slot.currentStatus())) {
