error id: file:///C:/Users/vguhankm/projects/MetroPark/Metropark/src/main/java/com/example/Metropark/service/ReservationService.java:java/lang/IllegalArgumentException#
...
public class ReservationService {
    ...
    public Mono<Integer> createReservation(ReservationDto dto) {
        ...
        return parkingSlotRepository.findById(dto.slotId())
                .switchIfEmpty(Mono.error(new Ill@@egalArgumentException("Slot does not exist.")))
                ...
                .flatMap(slot -> parkingSlotRepository.updateStatusWithOptimisticLock(slot.slotId(), "RESERVED",
                        slot.slotVersion()))
