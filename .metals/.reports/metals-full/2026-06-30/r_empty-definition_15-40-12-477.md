error id: file:///C:/Users/vguhankm/projects/MetroPark/Metropark/src/main/java/com/example/Metropark/controller/a.java:_empty_/ResponseEntity#
...
public class ParkingSlotController {
    ...
    public Mono<ResponseEntity<String>> updateStatus(
        ...
        return service.updateSlotStatus(id, status, currentVersion)
                .map(rows -> Response@@Entity.ok("Slot occupancy status updated successfully."))
                .onErrorResume(IllegalArgumentException.class, e -> 
                        Mono.just(ResponseEntity.badRequest().body(e.getMessage())))
