error id: file:///C:/Users/vguhankm/projects/MetroPark/Metropark/src/main/java/com/example/Metropark/service/ReservationService.java:java/lang/IllegalStateException#
...
public class ReservationService {
    ...
    public Mono<Integer> createReservation(ReservationDto dto) {
        ...
        return parkingSlotRepository.findById(dto.slotId())
                ...
                .switchIfEmpty(Mono.error(new Il@@legalStateException("Slot not available.")))
