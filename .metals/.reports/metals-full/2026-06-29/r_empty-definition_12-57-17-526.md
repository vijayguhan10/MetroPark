error id: file:///C:/Users/vguhankm/projects/MetroPark/Metropark/src/main/java/com/example/Metropark/controller/VehicleTypeController.java:_empty_/VehicleTypeService#updateVehicleType#
...
empty definition using pc, found symbol in pc: _empty_/VehicleTypeService#updateVehicleType#
...
public class VehicleTypeController {
    ...
    public Mono<ResponseEntity<String>> update(@PathVariable Integer id, @RequestBody VehicleTypeDto dto) {
        return service.updateV@@ehicleType(id, dto)
                .flatMap(rowsUpdated -> {
                    if (rowsUpdated > 0) {
