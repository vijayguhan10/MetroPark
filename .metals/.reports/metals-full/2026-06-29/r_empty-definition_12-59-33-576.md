error id: file:///C:/Users/vguhankm/projects/MetroPark/Metropark/src/main/java/com/example/Metropark/controller/VehicleTypeController.java:java/lang/IllegalArgumentException#
...
public class VehicleTypeController {
    ...
    public Mono<ResponseEntity<String>> update(@PathVariable Integer id, @RequestBody VehicleTypeDto dto) {
        return service.updateVehicleType(id, dto)
                ...
                .onErrorResume(IllegalArgumentExceptio@@n.class, e -> 
                        Mono.just(ResponseEntity.badRequest().body(e.getMessage())));
    }
