error id: file:///C:/Users/vguhankm/projects/MetroPark/Metropark/src/main/java/com/example/Metropark/controller/VehicleTypeController.java:java/lang/String#
...
public class VehicleTypeController {
    ...
    @PutMapping("/{id}")
    public Mono<ResponseEntity<S@@tring>> update(@PathVariable Integer id, @RequestBody VehicleTypeDto dto) {
