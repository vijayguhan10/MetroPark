error id: file:///C:/Users/vguhankm/projects/MetroPark/Metropark/src/main/java/com/example/Metropark/controller/ReservationClassController.java:_empty_/ResponseEntity#
...
public class ReservationClassController {
    ...
    public Mono<ResponseEntity<String>> update(@PathVariable Integer id, @RequestBody ReservationClassDto dto) {
        return service.updateReservationClass(id, dto)
                ...
                .onErrorResume(IllegalArgumentException.class, e -> 
                        Mono.just(ResponseEnti@@ty.badRequest().body(e.getMessage())));
    }
