error id: file:///C:/Users/vguhankm/projects/MetroPark/Metropark/src/main/java/com/example/Metropark/controller/VehicleTypeController.java:_empty_/ResponseEntity#ok#
...
public class VehicleTypeController {
    ...
    @PutMapping("/{id}")
    public Mono<ResponseEntity<Integer>> update(@PathVariable Integer id, @RequestBody VehicleTypeDto dto) {
