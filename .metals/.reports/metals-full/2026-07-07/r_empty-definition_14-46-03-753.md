error id: file:///C:/Users/vguhankm/projects/MetroPark/Metropark/src/main/java/com/example/Metropark/service/ParkingSessionService.java:java/lang/IllegalStateException#
    ...
    public Mono<Integer> createSession(ParkingSessionDto dto) {
        ...
        Mono<Void> userValidation = userRepository.findById(dto.userId())
                ...
                .flatMap(user -> "ACTIVE".equalsIgnoreCase(user.userStatus())
                        ? Mono.<Void>empty()
                        : Mono.error(new Ille@@galStateException("User account is inactive.")));
